...
export async function GET(request) {
  ...
  if (cleanBranch.includes("동탄")) {
    ...
    for (let i = 0; i < 6; i++) {
      fallbackTrend.push({
        month: months[i],
        ours: Math.round(46 + Math.sin(i + 1) * 9 + i * 3),
        comp1: Math.round(48 + Math.cos(i + 2) * 11 + i * 3), // 강남하이퍼 목동관
        comp2: Math.round(43 + Math.sin(i * 1.2 + 3) * 10 + i * 2), // 디랩 목동
        comp3: Math.round(45 + Math.cos(i * 0.8 + 4) * 8 + i * 2), // 수만휘 목동2관
        comp4: Math.round(49 + Math.sin(i + 5) * 9 + i * 2), // 잇올 목동 2관
        comp5: Math.round(47 + Math.cos(i + 6) * 10 + i * 3), // 종로학원 목동
        comp6: Math.round(44 + Math.sin(i + 7) * 7 + i * 2), // 수만휘 목동1관
        comp7: Math.round(50 + Math.cos(i + 8) * 8 + i * 3), // 잇올 목동 1관
        comp8: Math.round(46 + Math.sin(i + 9) * 7 + i * 2), // 잇올 목동 3관
        comp9: Math.round(52 + Math.cos(i + 10) * 11 + i * 3), // 러셀 목동
        comp10: Math.round(38 + Math.sin(i + 11) * 6 + i * 1) // PK 목동 1관
      });
    }
  ...
  } else if (cleanBranch.includes("부천")) {
    for (let i = 0; i < 6; i++) {
      fallbackTrend.push({
        month: months[i],
        ours: Math.round(45 + Math.sin(i + 1) * 8 + i * 3),
        comp1: Math.round(48 + Math.cos(i + 2) * 10 + i * 3), // 잇올 부천 1관
        comp2: Math.round(43 + Math.sin(i * 1.2 + 3) * 10 + i * 2), // 디랩 부천
        comp3: Math.round(47 + Math.cos(i * 0.8 + 4) * 9 + i * 2), // 잇올 부천 2관
        comp4: Math.round(44 + Math.sin(i + 5) * 8 + i * 2), // 부천 청솔학원
        comp5: Math.round(46 + Math.cos(i + 6) * 9 + i * 2), // 부천 메가스터디학원
        comp6: Math.round(49 + Math.sin(i + 7) * 10 + i * 3) // 메가스터디 러셀 부천
      });
    }
  } else if (cleanBranch.includes("부평") || cleanBranch.includes("인천부평")) {
    for (let i = 0; i < 6; i++) {
      fallbackTrend.push({
        month: months[i],
        ours: Math.round(45 + Math.sin(i + 1) * 8 + i * 3),
        comp1: Math.round(48 + Math.cos(i + 2) * 10 + i * 3) // 잇올 인천부평센터
      });
    }
  ...
  } else if (cleanBranch.includes("부산북구") || cleanBranch.includes("화명") || (cleanBranch.includes("부산") && cleanBranch.includes("북구"))) {
    for (let i = 0; i < 6; i++) {
      fallbackTrend.push({
        month: months[i],
        ours: Math.round(45 + Math.sin(i + 1) * 8 + i * 3),
        comp1: Math.round(48 + Math.cos(i + 2) * 10 + i * 3), // 잇올 부산 화명센터
        comp2: Math.round(46 + Math.sin(i * 1.2 + 3) * 11 + i * 2), // 잇올 몰입관 부산 동래사직캠프
        comp3: Math.round(44 + Math.cos(i * 0.8 + 4) * 9 + i * 2) // 잇올 부산 사직센터
      });
    }
  ...
  } else if (cleanBranch.includes("성북")) {
    for (let i = 0; i < 6; i++) {
      fallbackTrend.push({
        month: months[i],
        ours: Math.round(45 + Math.sin(i + 1) * 8 + i * 3),
        comp1: Math.round(48 + Math.cos(i + 2) * 10 + i * 3), // 잇올 성북센터
        comp2: Math.round(46 + Math.sin(i * 1.2 + 3) * 11 + i * 2), // 강북종로학원
        comp3: Math.round(42 + Math.cos(i * 0.8 + 4) * 8 + i * 2) // PK 성북점
      });
    }
  } else if (cleanBranch.includes("원주")) {
    for (let i = 0; i < 6; i++) {
      fallbackTrend.push({
        month: months[i],
        ours: Math.round(45 + Math.sin(i + 1) * 8 + i * 3),
        comp1: Math.round(44 + Math.cos(i + 2) * 10 + i * 2), // 수만휘 원주무실점
        comp2: Math.round(48 + Math.sin(i * 1.2 + 3) * 11 + i * 3), // 잇올 원주센터
        comp3: Math.round(47 + Math.cos(i * 0.8 + 4) * 9 + i * 2) // 러셀 원주
      });
    }
  } else if (cleanBranch.includes("성동")) {
    for (let i = 0; i < 6; i++) {
      fallbackTrend.push({
        month: months[i],
        ours: Math.round(45 + Math.sin(i + 1) * 8 + i * 3),
        comp1: Math.round(48 + Math.cos(i + 2) * 10 + i * 3), // 잇올 성동센터
        comp2: Math.round(43 + Math.sin(i * 1.2 + 3) * 10 + i * 2) // PK 성동점
      });
    }
  ...
  } else if (cleanBranch.includes("일산동구")) {
    for (let i = 0; i < 6; i++) {
      fallbackTrend.push({
        month: months[i],
        ours: Math.round(45 + Math.sin(i + 1) * 8 + i * 3),
        comp1: Math.round(44 + Math.cos(i + 2) * 10 + i * 2), // 수만휘 일산식사점
        comp2: Math.round(48 + Math.sin(i * 1.2 + 3) * 11 + i * 3), // 잇올 일산백마센터
        comp3: Math.round(46 + Math.cos(i * 0.8 + 4) * 9 + i * 2) // 일산청솔학원 네오관
      });
    }
    ...
    for (let i = 0; i < 6; i++) {
      fallbackTrend.push({
        ...
        comp2: Math.round(44 + Math.cos(i * 0.8 + 4) * 9 + i * 2), // 일산 청솔학원
        comp3: Math.round(48 + Math.sin(i * 1.2 + 3) * 11 + i * 3), // 잇올 일산주엽센터
  ...
  try {
    ...
    if (cleanBranch.includes("동탄") || cleanBranch.includes("목동") || cleanBranch.includes("오목교") || cleanBranch.includes("대전둔산") || cleanBranch.includes("둔산") || (cleanBranch.includes("대전") && !cleanBranch.includes("유성")) || cleanBranch.includes("강북") || cleanBranch.includes("김포") || cleanBranch.includes("송도") || cleanBranch.includes("인천송도") || cleanBranch.includes("분당정자") || cleanBranch.includes("분당") || cleanBranch.includes("대치") || cleanBranch.includes("이천기숙") || cleanBranch.includes("이천") || cleanBranch.includes("안성기숙") || cleanBranch.includes("안성") || cleanBranch.includes("부천")) {
      ...
      const isBucheon = cleanBranch.includes("부천");
      // 6+ groups exceeds Naver API limit (max 5 per call). We make parallel requests and normalize the scale using "ours"
      const body1 = {
        ...
        keywordGroups: isMokdong
          ? [
              ...
              { groupName: "comp4", keywords: ["잇올 스파르타 목동센터 2관", "목동 잇올 2관", "목동잇올 2관"] }
            ]
          : isDaejeonDunsan
          ? [
          ...
          : isBucheon
          ? [
              { groupName: "ours", keywords: ["부천 이투스247", "부천 이투스", "부천이투스", "신중동 이투스247", "상동 이투스247"] },
              { groupName: "comp1", keywords: ["잇올 스파르타 부천센터 1관", "부천 잇올 1관", "신중동 잇올"] },
              { groupName: "comp2", keywords: ["디랩 부천", "부천 디랩", "상동 디랩"] },
              { groupName: "comp3", keywords: ["잇올 스파르타 부천센터 2관", "부천 잇올 2관", "상동 잇올"] },
              { groupName: "comp4", keywords: ["부천 청솔학원", "부천 청솔", "송내 청솔학원"] }
            ]
          : isDaech
          ? [
      ...
      const body2 = {
        ...
        keywordGroups: isMokdong
          ? [
              ...
              { groupName: "comp8", keywords: ["잇올 스파르타 목동센터 3관", "목동 잇올 3관", "목동잇올 3관"] }
            ]
          : isDaejeonDunsan
          ? [
              { groupName: "ours", keywords: ["대전둔산 이투스247", "둔산 이투스247", "대전 이투스247", "둔산동 이투스"] },
          ...
          ? [
              { groupName: "ours", keywords: ["부천 이투스247", "부천 이투스", "부천이투스", "신중동 이투스247", "상동 이투스247"] },
              { groupName: "comp5", keywords: ["부천 메가스터디학원", "부천 메가스터디", "상동 메가스터디"] },
              { groupName: "comp6", keywords: ["메가스터디 러셀 부천", "러셀 부천", "부천 러셀"] }
            ]
          : isDaech
          ? [
              { groupName: "ours", keywords: ["대치 이투스247", "대치 이투스", "대치이투스"] },
      ...
      const data3 = body3 ? await responses[2].json() : null;
      ...
      const oursData3 = data3 ? (data3.results.find(r => r.title === "ours")?.data || []) : [];
      const comp9Data = data3 ? (data3.results.find(r => r.title === "comp9")?.data || []) : [];
      const comp10Data = data3 ? (data3.results.find(r => r.title === "comp10")?.data || []) : [];
      ...
      const realTrend = periodMonths.map((period, index) => {
        ...
        const oursVal3 = oursData3.find(d => d.period === period)?.ratio || 0;
        ...
        const comp9Val = comp9Data.find(d => d.period === period)?.ratio || 0;
        const comp10Val = comp10Data.find(d => d.period === period)?.ratio || 0;
        ...
        const factor3 = oursVal3 > 0 ? oursVal1 / oursVal3 : 1;
        const comp9ValNormalized = comp9Val * factor3;
        const comp10ValNormalized = comp10Val * factor3;
        ...
        if (isIcheon || isDongtan || isGangbuk || isMokdong || isBucheon) {
          row.comp6 = Math.round(comp6ValNormalized > 0 ? comp6ValNormalized : 15 + index);
        }
        if (isDongtan || isGangbuk || isMokdong) {
          row.comp7 = Math.round(comp7ValNormalized > 0 ? comp7ValNormalized : 12 + index);
        }
        if (isDongtan || isMokdong) {
          row.comp8 = Math.round(comp8ValNormalized > 0 ? comp8ValNormalized : 14 + index);
        }
        if (isMokdong) {
          row.comp9 = Math.round(comp9ValNormalized > 0 ? comp9ValNormalized : 18 + index);
          row.comp10 = Math.round(comp10ValNormalized > 0 ? comp10ValNormalized : 11 + index);
        }

        return row;
      });

      return NextResponse.json({ success: true, mode: isMokdong ? "naver-api-10comps" : isDongtan ? "naver-api-8comps" : isGangbuk ? "naver-api-7comps" : isIcheon || isBucheon ? "naver-api-6comps" : "naver-api-5comps", trendData: realTrend });
    } else {
      ...
      const isBusanGyodae = cleanBranch.includes("부산교대") || (cleanBranch.includes("교대") && !cleanBranch.includes("부산대") && !cleanBranch.includes("서면") && !cleanBranch.includes("북구") && !cleanBranch.includes("화명"));
      const isBusandae = cleanBranch.includes("부산대") && !cleanBranch.includes("부산교대") && !cleanBranch.includes("서면") && !cleanBranch.includes("북구") && !cleanBranch.includes("화명");
      const isBusanSeomyeon = cleanBranch.includes("부산서면") || cleanBranch.includes("서면");
      const isBusanBukgu = cleanBranch.includes("부산북구") || cleanBranch.includes("화명") || (cleanBranch.includes("부산") && cleanBranch.includes("북구"));
      ...
      const isIlsandonggu = cleanBranch.includes("일산동구");
      ...
      const isSeongbuk = cleanBranch.includes("성북");
      const isWonju = cleanBranch.includes("원주");
      const isSeongdong = cleanBranch.includes("성동");
      const isBupyeong = cleanBranch.includes("부평") || cleanBranch.includes("인천부평");
      const oursKeywords = isDokhakGisuk
        ...
        : isBusanBukgu
        ? ["부산북구 이투스247", "화명 이투스247", "부산북구 이투스", "화명동 이투스247", "화명 이투스"]
        : isGwangjuDonggu
        ...
        : isIlsandonggu
        ? ["일산동구 이투스247", "일산동구 이투스", "일산 이투스247", "식사동 이투스247", "마두동 이투스247"]
        : isIlsanseogu
        ? ["일산서구 이투스247", "일산 이투스247", "일산 이투스", "주엽 이투스247", "대화 이투스247"]
        : isDasan
        ...
        : isSeongbuk
        ? ["성북 이투스247", "서울성북 이투스247", "성북 이투스", "성북구 이투스247", "동소문 이투스247"]
        : isWonju
        ? ["원주 이투스247", "원주 이투스", "원주이투스", "무실동 이투스247", "단구동 이투스247"]
        : isSeongdong
        ? ["성동 이투스247", "서울성동 이투스247", "성동 이투스", "왕십리 이투스247", "행당동 이투스247"]
        : isBupyeong
        ? ["인천부평 이투스247", "부평 이투스247", "부평 이투스", "부평이투스"]
      ...
      const comp1Keywords = isDokhakGisuk
        ...
        : isBusanBukgu
        ? ["잇올 스파르타 부산 화명센터", "부산화명 잇올", "화명동 잇올"]
        : isGwangjuDonggu
        ...
        : isIlsandonggu
        ? ["수만휘 스파르타 일산식사점", "일산식사 수만휘", "식사동 수만휘"]
        : isIlsanseogu
        ? ["디랩 일산", "일산 디랩", "대화동 디랩"]
        : isDasan
        ...
        : isSeongbuk
        ? ["잇올 스파르타 성북센터", "성북 잇올", "동소문 잇올"]
        : isWonju
        ? ["수만휘 스파르타 원주무실점", "원주무실 수만휘", "무실동 수만휘"]
        : isSeongdong
        ? ["잇올 스파르타 성동센터", "성동 잇올", "행당동 잇올"]
        : isBupyeong
        ? ["잇올 스파르타 인천부평센터", "인천부평 잇올", "부평 잇올"]
      ...
      const comp2Keywords = isDokhakGisuk
        ...
        : isBusanBukgu
        ? ["잇올 몰입관 부산 동래사직캠프", "동래사직 잇올 몰입관", "동래 잇올 몰입관"]
        : isGwangjuDonggu
        ...
        : isSeongbuk
        ? ["강북종로학원", "강북종로", "성북 종로학원", "길음 종로학원"]
        : isWonju
        ? ["잇올 스파르타 원주센터", "원주 잇올", "단구동 잇올"]
        : isSeongdong
        ? ["PK독학재수학원 성동점", "성동 PK독학재수", "행당동 PK"]
      ...
      const comp3Keywords = isDokhakGisuk
        ...
        : isBusanBukgu
        ? ["잇올 스파르타 부산 사직센터", "부산사직 잇올", "사직동 잇올"]
        : isGwangjuDonggu
        ...
        : isIlsandonggu
        ? ["일산청솔학원 네오관", "일산청솔 네오관", "청솔학원 네오관"]
        : isIlsanseogu
        ? ["잇올 스파르타 일산주엽센터", "일산주엽 잇올", "주엽동 잇올"]
        : isMapo
        ? ["종로학원 강북", "강북 종로학원", "신촌 종로학원"]
        : isSeongbuk
        ? ["PK대치스파르타 성북점", "성북 PK대치스파르타", "종암동 PK"]
        : isWonju
        ? ["메가스터디 러셀 원주", "러셀 원주", "원주 러셀"]
        : [];
      ...
      if ((isDokhakGisuk || isDalseo || isGwangjuDonggu || isChuncheon || isHanam || isIlsandonggu || isIlsanseogu || isMapo || isBusanBukgu || isSeongbuk || isWonju) && comp3Keywords.length > 0) {
        keywordGroups.push({ groupName: "comp3", keywords: comp3Keywords });
      }
      if ((isGwangjuDonggu || isIlsanseogu || isMapo) && comp4Keywords.length > 0) {
      ...
      const realTrend = periodMonths.map((period, index) => {
        ...
        if (isDokhakGisuk || isDalseo || isGwangjuDonggu || isChuncheon || isHanam || isIlsandonggu || isIlsanseogu || isMapo || isBusanBukgu || isSeongbuk || isWonju) {
          row.comp3 = Math.round(comp3Val > 0 ? comp3Val : 6 + (hash % 6) + index);
        }
        if (isGwangjuDonggu || isIlsanseogu || isMapo) {
      ...
      return NextResponse.json({ success: true, mode: isGwangjuDonggu || isIlsanseogu || isMapo ? "naver-api-4comps" : isDokhakGisuk || isDalseo || isChuncheon || isHanam || isIlsandonggu || isBusanBukgu || isSeongbuk || isWonju ? "naver-api-3comps" : "naver-api", trendData: realTrend });
    }
  } catch (error) {

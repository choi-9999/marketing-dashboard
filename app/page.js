...
const branchCompetitorAddressMap = {
  ...
  "하남": [
    { name: "수능선배 하남점", address: "경기도 하남시 미사강변대로54번길 33 4층" },
  ...
  "일산동구": [
    { name: "수만휘 스파르타 일산식사점", address: "경기도 고양시 일산동구 원중1길 56 유니온스퀘어 8~9층" },
    { name: "잇올 스파르타 일산백마센터", address: "경기도 고양시 일산동구 일산로 197 센터21빌딩 3층" },
    { name: "일산청솔학원 네오관", address: "경기도 고양시 일산동구 일산로 197 센터21빌딩 4층" }
  ],
  "일산서구": [
    { name: "디랩 일산", address: "경기도 고양시 일산서구 중앙로 1559 10층" },
    { name: "일산 청솔학원", address: "경기도 고양시 일산서구 강성로 141 명운빌딩" },
    { name: "잇올 스파르타 일산주엽센터", address: "경기도 고양시 일산서구 중앙로 1415 CITY2000빌딩 6층" },
  ...
  "원주": [
    { name: "수만휘 스파르타 원주무실점", address: "강원특별자치도 원주시 능라동길 61 9층 (901호, 904호, 905호)" },
...
function getCompetitorsForBranch(branchName) {
  ...
  if (cleanName.includes("하남")) {
    return [
      {
        name: "수능선배 하남점",
        urgency: "high",
        metrics: { ours: { mgmt: 92, content: 94, facility: 90 }, theirs: { mgmt: 93, content: 78, facility: 92 } },
        trend: "1. 풍산동 미사강변 상권 1인 태블릿 자습석 및 실시간 화면 원격 감시 시스템 도입\n2. 등록 원생 대상 수능 배치 점수별 맞춤 원서 컨설팅 무료 지원",
        promotions: [
          { title: "수시/정시 입시 컨설팅 무료 제공", content: "등록 원생 대상 수능 배치 점수별 맞춤 원서 대면 컨설팅 무료 지원", url: "https://www.etoos.com" }
        ],
        guide: "1. [관리 방식 대응] 기계적 화면 감시보다 개개인의 학습 약점을 진단하고 보완하는 이투스247 1:1 밀착 학습 코칭의 교육적 우월성을 강조하십시오."
      },
      {
        ...
        urgency: "high",
        metrics: { ours: { mgmt: 92, content: 94, facility: 90 }, theirs: { mgmt: 92, content: 80, facility: 91 } },
        trend: "1. 풍산동 상아프라자 2 거점 엄격한 생활 통제 및 '잇올 티처스' 초개인화 멘토링 홍보\n2. 실전 수능 시뮬레이션 모의고사 및 외부생 응시 운영",
        promotions: [
          { title: "잇올 티처스 초개인화 멘토링 시스템", content: "전과목 학습 질문 및 개인별 학습 전략 설계 멘토링 지원", url: "https://www.etoos.com" }
        ],
        guide: "1. [코칭 시스템 대응] '잇올 티처스' 공세에 맞서 자사 담임 코치의 전담 밀착 관리 체계와 성적 향상 사례를 실증 자료로 제시하십시오."
      },
      {
        ...
        urgency: "high",
        metrics: { ours: { mgmt: 92, content: 94, facility: 90 }, theirs: { mgmt: 88, content: 80, facility: 90 } },
        trend: "1. 망월동 디럭스프라자2 중심 수만휘 회원 수강료 10% 감면 프로모션 및 생활 루틴 통제 홍보\n2. 주간 플래너 점검 및 등하원 알림 강조",
        promotions: [
          { title: "수만휘 회원 10% 수강료 지원", content: "수만휘 회원 인증 시 첫 달 등록 수강료 즉시 감면 프로모션", url: "https://www.etoos.com" }
        ],
        guide: "1. [입시 전문성 대응] 수강료 할인 공세에 맞서 이투스 교육평가연구소의 정밀 성적 분석 리포트 및 1:1 수시 컨설팅의 공신력을 부각하십시오."
  ...
  if (cleanName.includes("일산동구")) {
    return [
      {
        name: "수만휘 스파르타 일산식사점",
        urgency: "high",
        metrics: { ours: { mgmt: 92, content: 94, facility: 90 }, theirs: { mgmt: 88, content: 80, facility: 90 } },
        trend: "1. 식사동 유니온스퀘어 8~9층 거점 수만휘 회원 대상 수강료 지원 및 생활 루틴 통제 홍보\n2. 주간 플래너 점검 및 등하원 실시간 알림 마케팅",
        promotions: [
          { title: "수만휘 회원 10% 수강료 지원", content: "수만휘 회원 인증 시 첫 달 등록 수강료 즉시 감면 프로모션", url: "https://www.etoos.com" }
        ],
        guide: "1. [입시 전문성 대응] 수강료 할인 공세에 맞서 이투스 교육평가연구소의 정밀 성적 분석 리포트 및 1:1 수시/정시 컨설팅의 공신력을 부각하십시오."
      },
      {
        name: "잇올 스파르타 일산백마센터",
        urgency: "high",
        metrics: { ours: { mgmt: 92, content: 94, facility: 90 }, theirs: { mgmt: 93, content: 80, facility: 92 } },
        trend: "1. 마두동 일산로 센터21빌딩 3층 거점 대형 프리미엄 시설 및 '잇올 티처스' 초개인화 멘토링 홍보\n2. 실전 수능 시뮬레이션 모의고사 및 외부생 응시 운영",
        promotions: [
          { title: "잇올 티처스 초개인화 멘토링 시스템", content: "전과목 학습 질문 및 개인별 학습 전략 설계 멘토링 지원", url: "https://www.etoos.com" }
        ],
        guide: "1. [코칭 시스템 대응] '잇올 티처스' 공세에 맞서 자사 담임 코치의 전담 밀착 관리 체계와 성적 향상 사례를 실증 자료로 제시하십시오."
      },
      {
        ...
        urgency: "high",
        metrics: { ours: { mgmt: 92, content: 94, facility: 90 }, theirs: { mgmt: 91, content: 92, facility: 90 } },
        trend: "1. 센터21빌딩 4층 거점 선택형 단과 및 독학관리 융합 시스템 홍보\n2. 청솔 입시 데이터 기반 1:1 심층 성적 분석 리포트 배포",
        promotions: [
          { title: "네오관 선택형 단과 및 독학관리반 모집", content: "필요 수업만 선택 수강하는 자율 선택형 관리 프로그램", url: "https://www.etoos.com" }
        ],
        guide: "1. [완전 독학 맞춤 대응] 불필요한 의무 수업을 배제하고 오직 개인에게 필요한 학습과 피드백에 100% 집중하는 이투스247의 완벽한 독학 관리 체계를 부각하십시오."
      }
    ];
  ...
  if (cleanName.includes("목동") || cleanName.includes("오목교")) {
    return [
      {
        name: "강남하이퍼학원 목동관",
        urgency: "high",
  ...
  if (cleanName.includes("원주")) {
    return [
      {
        name: "수만휘 스파르타 원주무실점",
        urgency: "high",
        metrics: { ours: { mgmt: 92, content: 94, facility: 90 }, theirs: { mgmt: 88, content: 80, facility: 90 } },
        trend: "1. 무실동 능라동길 61 9층 거점 수만휘 회원 수강료 지원 및 생활 루틴 통제 홍보\n2. 주간 플래너 점검 및 등하원 실시간 알림 마케팅",
        promotions: [
          { title: "수만휘 회원 10% 수강료 지원", content: "수만휘 회원 인증 시 첫 달 등록 수강료 즉시 감면 프로모션", url: "https://www.etoos.com" }
        ],
        guide: "1. [입시 전문성 대응] 수강료 할인 공세에 맞서 이투스 교육평가연구소의 정밀 성적 분석 리포트 및 1:1 수시/정시 컨설팅의 공신력을 부각하십시오."
      },
      {
        ...
        urgency: "high",
        metrics: { ours: { mgmt: 92, content: 94, facility: 90 }, theirs: { mgmt: 93, content: 80, facility: 92 } },
        trend: "1. 단구동 서원대로 광장빌딩 4층 거점 대형 프리미엄 시설 및 '잇올 티처스' 초개인화 멘토링 홍보\n2. 실전 수능 시뮬레이션 모의고사 및 외부생 응시 운영",
        promotions: [
          { title: "잇올 티처스 초개인화 멘토링 시스템", content: "전과목 학습 질문 및 개인별 학습 전략 설계 멘토링 지원", url: "https://www.etoos.com" }
        ],
        guide: "1. [코칭 시스템 대응] '잇올 티처스' 공세에 맞서 자사 담임 코치의 전담 밀착 관리 체계와 성적 향상 사례를 실증 자료로 제시하십시오."
      },
      {
        ...
        trend: "1. 능라동길 25 3~5층 대형 바자관 인프라 및 스타강사 라이브 단과 연계 홍보\n2. 메가패스 결합 혜택 및 최상위권 장학 프로그램 강조",
        promotions: [
